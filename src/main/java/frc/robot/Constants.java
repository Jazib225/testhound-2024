...
public final class Constants {
        ...
        public static final class Manipulator {
                ...
                public static final Transform3d WRIST_TO_LEFT_PINCER = new Transform3d(
                                new Translation3d(0.049, 0.10, -0.045),
                                new Rotation3d());
                public static final Transform3d WRIST_TO_RIGHT_PINCER = new Transform3d(
                                new Translation3d(0.066, -0.10, -0.045),
                                new Rotation3d());
        ...
        public static final class Intake {
                ...
                public static final Pose3d LEFT_PASSOVER_RETRACTED_POSE = new Pose3d(0.139, 0.253, 0.168,
                                new Rotation3d());
                public static final Pose3d LEFT_PASSOVER_EXTENDED_POSE = new Pose3d(0.195, 0.17, 0.168,
                                new Rotation3d());
